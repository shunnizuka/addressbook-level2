...
public class FindCommand extends Command {
    ...
    private boolean isFindByTagCommand(Set<String> keywords) {
    ...
    private List<ReadOnlyPerson> getPersonsWithNameContainingAnyKeyword(Set<String> keywords) {
        ...
        for (ReadOnlyPerson person : addressBook.getAllPersons()) {
            ...
            final Set<Tag> tags = new HashSet<>(person.getTags());
            for(Tag tag : tags) {
    ...
    private List<ReadOnlyPerson> getPersonsWithTagContainingAnyKeyword(Set<String> keywords) throws IllegalValueException {
        final List<ReadOnlyPerson> matchedPersons = new ArrayList<>();
        ...
        for (ReadOnlyPerson person : addressBook.getAllPersons()) {
            final Set<Tag> tags = new HashSet<>(person.getTags());
            if (!Collections.disjoint(tags, keyToMatch)) {
                matchedPersons.add(person);
            }
        }
        return matchedPersons;
